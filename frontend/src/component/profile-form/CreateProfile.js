...
const CreateProfile = ({ createProfile, history }) => {
            ...
            const [displaySocialLink, toggle] = useState(false)
            const {
                        company,
                        website,
                        location,
            ...
            username</small
                                                ...
                                                <div className="my-2">
                                                            <button onClick={() => toggle(!displaySocialLink)} type="button" class="btn btn-light">
                                                                        Add Social Network Links
          </button>
                                                            <span>Optional</span>
                                                </div>
                                                {displaySocialLink ? (<>
                                                            <div className="form-group social-input" style={{
                                                                        transition: 'all 2s'
                                                            }}>
...
{/*without withRouter we cannot use history*/ }
